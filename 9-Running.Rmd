...
You may need to create a PDF of your survey to attach to an Ethics application or to include as an appendix in a report. This is easy to do within the survey. 
...
Then select Printable from the options available. This will let you print or save a copy of your survey (print to PDF).
